...
function check_value() {
  ...
  if (data1 == "" || data2 == "" || data3 == "" || data4 == "" || data5 == "" || data7 == "" || data8 == "" || data9 == "") {
...
function myCreateFunction() {
  ...
  for (var i = 1; i <= 10; i++) {
    ...
    if (i < 7) { var data = eval("data" + i); }
    else if (i == 7) { var data = ((data2 * data3) / data4 - data1).toFixed(1); }
    else if (i == 8) { var data = eval("data" + (i - 1)); }
    else if (i == 9) { var data = data8 + "Volt, " + data9 + "Hz "; }
    else if (i == 10) {
      var data = "YES"
      if (flag1 == 0)
        data = "NO"
            ...
            if (s[1] != 'r' || s_element.has(s) || amp[s].length != 3 || amp[s][2] != arr[2])
              ...
              if (s[1] = !'r' || s_element.has(s) || amp[s].length != 2)
                ...
                if (s[1] != 'm' || amp[s].length != 2)
                  ...
                  var q = document.getElementById("r5");
                  ...
                  $("<div class='r1_tag' style = 'position: absolute;top:" + r_pos[i][0] + "px ; left:" + r_pos[i][1] + "px ;'><b>AC Source" + "</b></div>")
                    .appendTo("#diagram");
                  ...
                  $("<div class='r1_tag' style = 'position: absolute;top:" + r_pos[i][0] + "px ; left:" + r_pos[i][1] + "px ;'><b>c" + "</b></div>")
                    .appendTo("#diagram");
                  i++;
                  s = "im1"
                  r_top = document.querySelector('#' + s + '').getBoundingClientRect().bottom - p_top;
                  ...
                  $("<div class='r1_tag' style = 'position: absolute;top:" + r_pos[i][0] + "px ; left:" + r_pos[i][1] + "px ;'><b>l(unknown)" + "</b></div>")
                    .appendTo("#diagram");
                  ...
                  //   $("<div class='r1_tag' style = 'position: absolute;top:" + r_pos[i][0] + "px ; left:" + r_pos[i][1] + "px ;'><b>r" + "</b></div>")
                  //   .appendTo("#diagram");
